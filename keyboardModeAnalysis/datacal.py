...
def load_csdn(part="all"):
    ...
    ts = []
    if part == "all":
        with open("D:\mine\yanyi\web大作业\data\www.csdn.net.sql", "r", encoding="cp950", errors="ignore") as f:
...
def load_yahoo(part="all"):
    ...
    ts = []
    if part == "all":
        with open("D:\mine\yanyi\web大作业\data\plaintxt_yahoo.txt", "r", encoding="cp950", errors="ignore") as f:
            for line in tqdm(f.readlines()):
